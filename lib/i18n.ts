...
export const interfaceCopy = {
  en: {
    ...
    showProjectPage: "Show project page",
    ...
    resumePage: "Page",
    previousResumePage: "Previous resume page",
    nextResumePage: "Next resume page",
    showResumePage: "Show resume page",
  ...
  es: {
    ...
    showProjectPage: "Mostrar página de proyectos",
    ...
    resumePage: "Página",
    previousResumePage: "Página anterior del currículum",
    nextResumePage: "Página siguiente del currículum",
    showResumePage: "Mostrar página del currículum",
